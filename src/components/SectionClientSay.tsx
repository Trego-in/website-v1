...
const DEMO_DATA = [
  {
    ...
    content:
      "Thanks for saving my time. Great service, Keep it up!",
  },
  {
    id: 2,
    ...
    content:
      "I got deal of my car service for the first time ever. Really awesome!",
  },
  {
    id: 3,
    ...
    clientAddress: "Tokyo",
    content:
      "Really thanks for considering my post service feedback carefully, well done!",
  },
];
