...
const typeOfPaces = [
	{
		name: 'Royal Enfield',
		description: '20 service centers',
	},
	{
		name: 'Yamaha',
		description: '10 service centers',
	},
	{
		name: 'Bajaj',
		description:
	...
	{
		name: 'TVS',
		description: 'Express service, 20 deals, 20 service centers',
	},
]
...
const moreFilter1 = [
	{ name: 'Customer seating area', defaultChecked: false },
	{ name: 'Air conditioning', defaultChecked: false },
	{ name: 'Parking area' },
	{ name: 'Wifi' },
	{ name: 'Mobile charging points' },
]

const moreFilter2 = [
	{ name: ' Advance booking' },
	{ name: 'Customer support' },
	{ name: 'Post service support' },
					...
					<>
						...
						>
							<PopoverPanel className="absolute left-0 z-10 mt-3 w-screen max-w-sm px-4 sm:px-0 lg:max-w-md">
								<div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-xl dark:border-neutral-700 dark:bg-neutral-900">
									<div className="relative flex flex-col space-y-5 px-5 py-6">
										<NcInputNumber label="Distance" max={10} />
										<NcInputNumber label="Popularity" max={10} />
										<NcInputNumber label="Reviews & Rating" max={10} />
									</div>
									<div className="flex items-center justify-between bg-neutral-50 p-5 dark:border-t dark:border-neutral-800 dark:bg-neutral-900">
										<ButtonThird onClick={close} sizeClass="px-4 py-2 sm:px-5">
											Clear
