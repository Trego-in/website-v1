...
export const includes_demo = [
  { name: "Cancel for free, zero hassle guaranteed" },
  { name: "Best price guaranteed, with exlusive offers" },
  { name: "Dedicated relationship manager for best insurance & loan assistance " },
  { name: "Guaranteed gifts with your dream car" },
  {
    name: "Thorough inspection by Trego before car delivery",
  },
  { name: "Creating unforgettable moments with our grand delivery" },
];
