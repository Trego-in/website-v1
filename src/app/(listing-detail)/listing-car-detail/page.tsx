...
const ListingCarDetailPage: FC<ListingCarDetailPageProps> = ({}) => {
    ...
    return (
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex justify-between items-center">
          <Badge color="pink" name="BMW" />
          <Badge color="blue" name="sedan" />
          <Badge color="blue" name="petrol" />
          <Badge color="blue" name="Manual" />
          <Badge color="blue" name="Automatic" />
          <LikeSaveBtns />
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <span>
            ...
            <span className="ml-1"> Banglore, Indian</span>
          </span>
        </div>
        ...
        <div className="flex items-center">
          ...
          <span className="ml-2.5 text-neutral-500 dark:text-neutral-400">
            ...
            <span></span>
            <Badge color="blue" name="90k discount" />
            <Badge color="blue" name="express delivery" />
          </span>
        </div>
      ...
      <div className="listingSection__wrap">
        <div>
          ...
          <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
            Questions that are at the heart of you.
          </span>
        </div>
  ...
  const renderSection3 = () => {
    return (
      <div className="listingSection__wrap">
        <div>
          <h2 className="text-2xl font-semibold">The Trego Edge </h2>
          <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
            The best value recommended by Trego for you
          </span>
        </div>
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700"></div>
        {/* 6 */}
  ...
  //         <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
  //           San Diego, CA, United States of Amer (SAN-San Diego Intl.)
  //         </span>
  //       </div>
  ...
  const renderSection7 = () => {
    return (
      <div className="listingSection__wrap">
        ...
        {/* CONTENT */}
        <div>
          <h4 className="text-lg font-semibold">Test Drive Booking Charges</h4>
          <span className="block mt-3 text-neutral-500 dark:text-neutral-400">
          Booking a test ride is completely free of charge. 
          </span>
        </div>
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700" />
        ...
        <div>
          ...
          <span className="block mt-3 text-neutral-500 dark:text-neutral-400">
          Secure this exceptional price today! Reserve now and enjoy the flexibility to cancel
           your booking at any time, with no questions asked.
          </span>
        </div>
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700" />
        ...
        <div>
          ...
          <span className="block mt-3 text-neutral-500 dark:text-neutral-400">
          We prioritize your data privacy. Rest assured, we will only share your contact information
           with the selected dealer of your choice, and only after receiving your confirmation.
          </span>
        </div>
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700" />
        ...
        <div>
          ...
          <span className="block mt-3 text-neutral-500 dark:text-neutral-400">
          We are committed to providing you with the best service and convenience, and our dealers 
          share the same dedication. To ensure we continue offering you the best experience, 
          we kindly ask that you book a test ride only if you are genuinely interested in purchasing a car.
          </span>
        </div>
      </div>
    );
